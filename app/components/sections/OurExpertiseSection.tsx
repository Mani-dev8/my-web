...
function OurExpertiseSection({ }: Props) {
  return (
    <section className='flex flex-col items-center justify-center py-16 bg-zinc-100'>
...
const services = [
  {
    ...
    description: "Crafting seamless, user-centered interfaces that turn ideas into intuitive digital experiences.",
    imageAlt: "Person wearing VR headset working on holographic UI designs",
    imgSrc: '/home/expertise1.png'
  },
  {
    title: "Brand Solution",
    description: "Transforming ideas into memorable brand experiences that resonate with your audience.",
  ...
  },
  {
    ...
    description: "Delivering end-to-end digital solutions that combine functionality, performance, and design.",
    imageAlt: "Developer working on multiple screens with code and designs",
    imgSrc: '/home/expertise3.png'
  },
  {
    title: "Media Solution",
    description: "Transforming ideas into impactful media experiences across digital and traditional platforms.",
  ...
  },
  {
    ...
    description: "Guiding brands with smart, research-backed strategies that deliver impact.",
    imageAlt: "Person looking at whiteboard covered with sticky notes and sketches",
    imgSrc: '/home/expertise5.png'
  },
  {
    title: "Immersive 3D Visuals",
    description: "Crafting realistic and captivating 3D designs that bring ideas to life.",
    imageAlt: "3D rendered modern chair displayed on a digital screen with 'Successfully Connected' text",
