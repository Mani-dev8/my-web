...
function ElevatedIcon({ size, icon, className }: ElevatedIconProps) {
    ...
    return (
        ...
        >
            <div className="relative flex h-full w-full items-center justify-center rounded-[20px] bg-gradient-to-br from-pink-400 via-pink-500 to-pink-600 shadow-[inset_0_2px_4px_rgba(255,255,255,0.4),inset_0_-6px_10px_rgba(0,0,0,0.15)] ring-1 ring-white/20">
                ...
                <div className="relative drop-shadow-sm">
                    {icon ?? <TrendingUp className="h-10 w-10 text-white" strokeWidth={3} />}
                </div>
            </div>
        </div>
    );
